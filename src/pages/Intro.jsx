  ...
  return (
    <div>
      <section className="intro-container">
        ...
        <p>
          Questo progetto consiste nella creazione di un un sistema di
          navigazione e controllo di una barca robotica utilizzando una scheda
          Arduino.
        </p>
        <p>
        ...
        <p>
          ...
          elettronica, composta da una scheda di sviluppo e un ambiente di
          programmazione. Permette di creare progetti interattivi utilizzando
          sensori, attuatori e microcontrollori, rendendo l'elettronica
          accessibile a tutti.
        </p>
        <h3>indice</h3>
        <section>
